...
from api.cuas.latresne.CUA.map2d.carte2d.carte2d_extraction import (
    ENGINE,
    charger_catalogue,
    selectionner_couches_pour_parcelle,
    extraire_entites_pour_couche,
)
from api.cuas.latresne.CUA.map2d.carte2d.carte2d_metier import construire_couche_metier
from api.cuas.latresne.CUA.map2d.map_utils import random_color
from api.cuas.latresne.CUA.ppri.ppri_map_module import ajouter_ppri_a_carte
...
# Fond raster IGN Plan (même famille que le style vectoriel Argelès PLAN.IGN).
# WMTS public Géoplateforme, sans clé. Les HTML déjà stockés gardent l’ancien fond Carto.
BASEMAP_CONF = {
    "tiles": (
    ...
    "attr": "© IGN — Géoplateforme (Plan IGN)",
}
