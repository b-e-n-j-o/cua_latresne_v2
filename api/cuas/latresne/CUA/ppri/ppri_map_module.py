...
from api.cuas.latresne.CUA.ppri.ppri_analyse_tolerance import analyser_ppri_tolerance
...
def ajouter_ppri_a_carte(
    ...
    if not parcelle_wkt:
        ...
        from api.cuas.latresne.CUA.map2d.map_utils import get_parcelle_geometry
