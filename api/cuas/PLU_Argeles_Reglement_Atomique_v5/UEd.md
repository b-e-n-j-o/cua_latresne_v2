# Reglement du PLU d'Argeles-sur-Mer - Zone UEd

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Equipements lies a la production ou distribution d'electricite.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UEd** (chapitre "zone UE"). Les regles propres aux autres sous-secteurs du chapitre (UEa, UEb, UEc, UEs, UEm) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UEd sont conservees.

---

## Reglement applicable a la zone UEd


## Chapitre 6. La zone UE

La zone UE correspond aux secteurs d’équipements de la commune
Cette zone UE est divisée 5 secteurs :
- Le secteur UEa qui regroupe la majorité des équipements répartis sur le territoire communal (Equipements sportifs, culturels, station d’épuration, locaux techniques, etc.). Ce secteur est également voué à accueillir le siège du Parc Marin, La capitainerie, etc.
- Le secteur UEb correspond quant à lui au secteur d’équipement situé sur le front de Mer à
Argelès Plage.
- Le secteur UEc correspond quant à lui au secteur d’équipement situé sur Valmy et qui permettra d’accueillir des équipements publics ou d’intérêt collectif ainsi que des hébergements qui peuvent y être liés.
- Le secteur UEd correspond à un secteur lié à la production/distribution d’électricité
- Le secteur UEs correspond à un secteur à vocation d’équipements de sports et de loisirs au
Tamariguer
- Le secteur UEm correspond à un secteur dédié à la création d’une maison médicale
...
### ARTICLE UE 1.1 - INTERDICTION ET LIMITATION DE CERTAINS USAGES ET
...
**Dans l’ensemble de la zone UE (UEa, UEb, UEd,**
...
Tech, aires de circulation des modes doux de déplacements dans le cadre de la mise en œuvre du schéma national des véloroutes voies vertes, et sous réserve qu'il prenne en compte le risque inondation et qu'il n'aggrave pas la situation existante.
  - L’extension des bâtiments liés à une activité commerciale ou de service existante dans la zone au moment de l’approbation du PLU :
...
- Dans la limite de 30 % de la surface de plancher initiale en zone UEa, UEb, UEd, UEs
  ...
  - Sous condition que cette extension soit liée à la mise aux normes du bâtiment en termes d’accessibilité
  - Dans la limite de 30 % de la surface de plancher initiale
Cf. dispositions de l’ensemble de la zone UE

**Dans le seul secteur UEd :**


**En sus des dispositions de l’ensemble de la zone UE :**
...
Tout projet sera soumis à l’avis d’un paysagiste conseil.
Cf. dispositions de l’ensemble de la zone UE Dans le seul secteur UEs :

**En sus des dispositions de l’ensemble de la zone UE :**

- Les aires de stationnement indispensables à la maîtrise de la fréquentation publique telles que prévues aux articles R121-5 du
Code de l'Urbanisme à condition que ces aires ne soient ni cimentées, ni bitumées.
...
### ARTICLE UE. 1.2. – MIXITE FONCTIONNELLE ET SOCIALE
...
### ARTICLE UE. 2.1. – VOLUMETRIE ET IMPLANTATION DES CONSTRUCTIONS
...
Dans les autres cas :
Une façade des bâtiments doit être implantée :
 Soit à l'alignement des voies publiques ou à la limite qui s’y substitue pour les voies privées, existantes ou à créer
 Soit en respectant un retrait de 5 mètres minimum par rapport aux voies publiques ou à la limite qui s’y substitue pour les voies privées, existantes ou à créer.
Toutefois, lorsque le bâtiment projeté jouxte une autre construction en bon état mais implantée différemment des règles ci-dessus, le nouveau bâtiment peut être implantée avec le même recul si la continuité et la cohérence de l’alignement sur rue n’est pas rompue.
...
Les bâtiments peuvent être édifiés sur une limite séparative latérale ou en retrait des limites séparatives latérales et de fond de parcelle.
...
### ARTICLE UE. 2.2. – INSERTION ARCHITECTURALE, URBAINE, PAYSAGERE ET
...
### ARTICLE UE. 2.3. - ESPACES LIBRES ET PLANTATIONS
...
### ARTICLE UE. 3.1. - OBLIGATIONS IMPOSEES AUX CONSTRUCTIONS, TRAVAUX,
...
### ARTICLE UE. 3.2. - ACCES ET VOIRIE
...
### ARTICLE UE. 3.3. - CONDITIONS DE DESSERTE PAR LES RESEAUX
...
En l’absence d’un réseau collectif, les bâtiments ou installations nouvelles devront être équipées d’un système d’assainissement autonome conforme aux normes en vigueur. Dans ce cas, les installations devront être réalisées de telle façon qu’elles puissent se raccorder aux futurs réseaux collectifs.
- DECHETS :
