# Reglement du PLU d'Argeles-sur-Mer - Zone UXe

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Centrale de cogeneration (energies renouvelables).

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UXe** (chapitre "zone UX"). Les regles propres aux autres sous-secteurs du chapitre (UXa, UXb, UXc, UXd) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UXe sont conservees.

---

## Reglement applicable a la zone UXe
...
**Sont autorisées sous conditions :**
  ...
  - Les activités industrielles à condition qu’elles soient liées à une activité de recyclage ou à la production d’énergie (énergie renouvelable et biomasse)
