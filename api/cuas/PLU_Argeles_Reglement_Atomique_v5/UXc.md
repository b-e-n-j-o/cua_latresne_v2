# Reglement du PLU d'Argeles-sur-Mer - Zone UXc

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Activites economiques - zones artisanales et industrielles.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UXc** (chapitre "zone UX"). Les regles propres aux autres sous-secteurs du chapitre (UXa, UXb, UXd, UXe) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UXc sont conservees.

---

## Reglement applicable a la zone UXc
...
- Les sous destinations suivantes :
  ...
  - Le commerce de détail, restauration,
