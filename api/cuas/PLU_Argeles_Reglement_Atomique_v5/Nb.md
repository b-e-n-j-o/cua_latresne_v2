# Reglement du PLU d'Argeles-sur-Mer - Zone Nb

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Secteur naturel boise des Alberes (activites agro-pastorales).

> Les dispositions ci-dessous sont celles applicables au sous-secteur **Nb** (chapitre "zone N"). Les regles propres aux autres sous-secteurs du chapitre (N, NTcl, Nc, Nd, Ne, Ng, Nj, Nm, Nrl) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant Nb sont conservees.

---

## Reglement applicable a la zone Nb
...
- Les annexes aux habitations (y compris les piscines) légalement autorisées ou répertoriées au zonage comme ayant un caractère architectural ou patrimonial (au titre de l’article L151-19 du code de l’urbanisme), à condition :
