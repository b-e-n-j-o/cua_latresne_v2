# Reglement du PLU d'Argeles-sur-Mer - Zone UBa2

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Secteur residentiel de Prada Baixa (lotissement Rue du Brigantin, Rue des Trois mats).

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UBa2** (chapitre "zone UB"). Les regles propres aux autres sous-secteurs du chapitre (UBa1, UBb, UBc, UBd, UBe, UBf) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UBa2 sont conservees.

---

## Reglement applicable a la zone UBa2
