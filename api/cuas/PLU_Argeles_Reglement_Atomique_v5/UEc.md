# Reglement du PLU d'Argeles-sur-Mer - Zone UEc

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Equipements publics ou d'interet collectif et hebergements lies.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UEc** (chapitre "zone UE"). Les regles propres aux autres sous-secteurs du chapitre (UEa, UEb, UEd, UEs, UEm) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UEc sont conservees.

---

## Reglement applicable a la zone UEc
