# Reglement du PLU d'Argeles-sur-Mer - Zone UBe

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Domaine des Golfes Clairs a Argeles Plage.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UBe** (chapitre "zone UB"). Les regles propres aux autres sous-secteurs du chapitre (UBa1, UBa2, UBb, UBc, UBd, UBf) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UBe sont conservees.

---

## Reglement applicable a la zone UBe
...
- L’extension ou la création de bâtiments d'activités commerciales ou de services à condition qu'elles soient compatibles avec le caractère de la zone et qu’elles n'entraînent pas pour le voisinage : nuisances, insalubrité, …
