# Reglement du PLU d'Argeles-sur-Mer - Zone UXd

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Activites economiques - activites commerciales au developpement limite.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UXd** (chapitre "zone UX"). Les regles propres aux autres sous-secteurs du chapitre (UXa, UXb, UXc, UXe) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UXd sont conservees.

---

## Reglement applicable a la zone UXd
...
- Les sous destinations suivantes :
  ...
  - L’artisanat, Le commerce de détail, restauration,
...
PLU.
  - Les constructions à usage d’entrepôts à condition d’être liés à une autre destination ou sous- destination autorisée dans la zone
  - L’extension des activités commerciales existantes dans la limite de 30 % de l’emprise au sol existante à la date d’approbation du présent PLU.
