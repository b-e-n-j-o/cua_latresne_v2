# Reglement du PLU d'Argeles-sur-Mer - Zone UTh2

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Hotellerie et activites touristiques.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UTh2** (chapitre "zone UT"). Les regles propres aux autres sous-secteurs du chapitre (UTc, UTrt, UTh1, UTh3) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UTh2 sont conservees.

---

## Reglement applicable a la zone UTh2
...
- Sont autorisées sous conditions :
  - L’extension au titre de l’article L151-12 du Code de l’Urbanisme, des constructions existantes à la date d’approbation du PLU et légalement autorisées, dans la limite de 15 % de l’emprise au sol existante à la date d’approbation du présent
PLU, à condition :
...
**Dans les seuls secteurs UTh1, UTh2, UTh3 :**
