# Reglement du PLU d'Argeles-sur-Mer - Zone UEs

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Equipements au Tamariguer (sports et loisirs).

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UEs** (chapitre "zone UE"). Les regles propres aux autres sous-secteurs du chapitre (UEa, UEb, UEc, UEd, UEm) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UEs sont conservees.

---

## Reglement applicable a la zone UEs
...
**Dans le seul secteur UEs**

Dans le secteur UEs, les places de stationnement devront impérativement être non imperméabilisées.
