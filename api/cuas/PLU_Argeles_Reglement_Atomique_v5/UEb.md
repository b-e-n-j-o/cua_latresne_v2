# Reglement du PLU d'Argeles-sur-Mer - Zone UEb

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Equipements d'Argeles Plage (siege du Parc Marin, capitainerie).

> Les dispositions ci-dessous sont celles applicables au sous-secteur **UEb** (chapitre "zone UE"). Les regles propres aux autres sous-secteurs du chapitre (UEa, UEc, UEd, UEs, UEm) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant UEb sont conservees.

---

## Reglement applicable a la zone UEb
