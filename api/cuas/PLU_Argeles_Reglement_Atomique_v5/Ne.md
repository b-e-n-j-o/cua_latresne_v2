# Reglement du PLU d'Argeles-sur-Mer - Zone Ne

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Secteurs d'equipement en zone naturelle.

> Les dispositions ci-dessous sont celles applicables au sous-secteur **Ne** (chapitre "zone N"). Les regles propres aux autres sous-secteurs du chapitre (N, NTcl, Nb, Nc, Nd, Ng, Nj, Nm, Nrl) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant Ne sont conservees.

---

## Reglement applicable a la zone Ne
...
**Dans les seules zones Ne, Ng et Nd :**

L’emprise au sol de l’ensemble des constructions est limitée à 30 % de la surface de la parcelle ou de l’unité foncière.
