# Reglement du PLU d'Argeles-sur-Mer - Zone Nc

**Commune d'Argeles-sur-Mer** - modification de droit commun n.2 - version 30/10/2025

## Vocation de la zone
Sous-secteur naturel (mentionne dans la liste des sous-secteurs du chapitre N).

> Les dispositions ci-dessous sont celles applicables au sous-secteur **Nc** (chapitre "zone N"). Les regles propres aux autres sous-secteurs du chapitre (N, NTcl, Nb, Nd, Ne, Ng, Nj, Nm, Nrl) ont ete ecartees ; les regles communes a plusieurs sous-secteurs incluant Nc sont conservees.
