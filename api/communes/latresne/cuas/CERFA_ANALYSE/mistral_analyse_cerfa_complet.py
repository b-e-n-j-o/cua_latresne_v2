...
from api.communes.latresne.cuas.CERFA_ANALYSE.mistral_cerfa_info_extractor import extraire_info_cerfa
from api.communes.latresne.cuas.CERFA_ANALYSE.mistral_cerfa_parcelles_extractor import extraire_parcelles_cerfa
