...
try:
    from api.communes.latresne.cuas.CUA.ppri.ppri_analyse_tolerance import engine as ENGINE_PPRI
...
try:
    from api.communes.latresne.cuas.CUA.ppri.cote_ngf import cote_ngf_parcelle
except ImportError:
...
try:
    from api.communes.latresne.cuas.CUA.ppri.ppri_analyse_tolerance import engine as ppri_engine
    engine = ppri_engine
...
def analyser_ppri_corrige(geom_wkt=None, section=None, numero=None, code_insee=None, engine=None, **kwargs):
    ...
    from api.communes.latresne.cuas.CUA.ppri.ppri_analyse_tolerance import (
        analyser_ppri_tolerance,
        engine as ppri_engine,
    )
