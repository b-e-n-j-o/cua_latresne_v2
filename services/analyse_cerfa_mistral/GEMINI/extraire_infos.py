...
Retourne UNIQUEMENT le JSON."""
    ...
    def _pil_to_parts(self, images: list) -> list:
    ...
    def extraire(
        ...
        try:
            ...
            image_parts = self._pil_to_parts(images)
            ...
            if usage:
                cost_input  = (getattr(usage, "prompt_token_count",     0) / 1_000_000) * 0.075
                cost_output = (getattr(usage, "candidates_token_count", 0) / 1_000_000) * 0.30
                usage_dict  = {
                ...
                logger.info("Gemini API call completed", extra={
                    "model": model, **usage_dict, "duration_ms": duration_ms,
                })
            ...
            return {"success": True, "data": data, "usage": usage_dict, "model": model}
