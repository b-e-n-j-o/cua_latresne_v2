...
Retourne UNIQUEMENT le JSON."""
    ...
    def _pdf_to_images(self, pdf_path: str, pages: list = None, dpi: int = 250) -> list:
        ...
        # Pages 1-2 seulement (infos utiles pour les infos générales)
        if pages is None:
            pages = [1, 2]
    ...
    def extraire(
        ...
        try:
            logger.info("Calling Mistral for general info extraction", extra={
                "model": model,
                "pages": pages or [1, 2],
            })
            ...
            try:
                ...
                logger.exception("Mistral API error", extra={
                    "model": model,
            ...
            logger.info("Mistral API call completed", extra={
