...
Usage local :
  cd cua_latresne_v4
  python services/ingestion/ingestion_cadastre/run_etl_commune.py --schema latresne --insee 33234 --parcelles-mode etalab
"""
...
from services.ingestion.ingestion_cadastre.etl_pipeline import (  # noqa: E402
    DEFAULT_BACKEND_URL,
    EtlConfig,
    execute_etl,
    sanitize_insee,
