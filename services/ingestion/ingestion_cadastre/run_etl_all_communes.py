...
Usage (depuis la racine cua_latresne_v4) :
  python services/ingestion/ingestion_cadastre/run_etl_all_communes.py
  python services/ingestion/ingestion_cadastre/run_etl_all_communes.py --config path/to/communes.json
  python services/ingestion/ingestion_cadastre/run_etl_all_communes.py --dry-run
...
from services.ingestion.ingestion_cadastre.etl_pipeline import EtlConfig, execute_etl  # noqa: E402
