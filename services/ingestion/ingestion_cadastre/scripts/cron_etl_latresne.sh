...
#   crontab -e
#   0 3 * * * /Volumes/T7/Travaux_Freelance/KERELIA/CUAs/BACKEND_PRINCIPAL/LATRESNE/cua_latresne_v4/services/ingestion/ingestion_cadastre/scripts/cron_etl_latresne.sh >> /tmp/etl_latresne.log 2>&1
